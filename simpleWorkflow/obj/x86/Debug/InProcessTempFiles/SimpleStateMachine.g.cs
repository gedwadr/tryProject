...
namespace simpleWorkflow {
    ...
    public partial class SimpleStateMachine : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SimpleStateMachine).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SimpleStateMachine));
        ...
        private string FindResource() {
            string[] resources = typeof(SimpleStateMachine).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SimpleStateMachine.g.xaml") || resource.Equals("SimpleStateMachine.g.xaml"))) {
                    return resource;
                }
            }
